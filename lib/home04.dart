...
class AppBarD extends StatefulWidget with PreferredSizeWidget {

  @override
  _AppBarDState createState() => _AppBarDState();

  @override
  Size get preferredSize => Size.fromHeight(kToolbarHeight);
}

class _AppBarDState extends State<AppBarD> {
